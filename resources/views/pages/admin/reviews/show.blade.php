...
@section('title', 'Review Produk: ' . $product->name)
        ...
        <section class="section">
            <div class="section-header">
                <div class="section-header-back">
                    <a href="{{ route('admin.products.reviews') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
                </div>
                <h1>Ulasan Produk: {{ $product->name }}</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
                    <div class="breadcrumb-item"><a href="#">Ulasan</a></div>
                    <div class="breadcrumb-item">Daftar ulasan produk</div>
                </div>
            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form id="deleteForm{{ $review->id }}"
                                                    action="{{ route('admin.reviews.destroy', ['product_id' => $product->id, 'review_id' => $review->id]) }}"
                                                    method="POST"
