        ...
        <section class="section">
            ...
            <div class="section-body">
                ...
                <p class="section-lead">
                    Buat data admin baru dengan mengisi form di bawah ini.
                </p>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('admin.user.store') }}" class="needs-validation"
                                    novalidate="">
                                    @csrf
                                    ...
                                    <div class="form-group row mb-4">
                                        <div class="col-sm-12 col-md-7 offset-md-3">
                                            <button class="button-custom" type="submit">Simpan Data Admin</button>
                                        </div>
                                    </div>
                                </form>
